...
export CORE_UTILIZATION=50 			#FINAL VALUE

export TNS_END_PERCENT = 100        #FINAL VALUE

export REMOVE_ABC_BUFFERS = 1 		#FINAL VALUE

export RECOVER_POWER=45			    #FINAL VALUE

export MATCH_CELL_FOOTPRINT=0       #FINAL VALUE
...
export MIN_BUF_CELL_AND_PORTS=1     #FINAL VALUE

export USE_FILL=1 					#FINAL value
export ENABLE_DPO=1
